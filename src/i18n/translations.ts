...
const translations = {
  ...
  "auth.account": { en: "Account", es: "Cuenta" },
  "auth.forgotPassword": { en: "Forgot password?", es: "¿Olvidaste tu contraseña?" },
  "auth.backToLogin": { en: "Back to login", es: "Volver al inicio de sesión" },
  "auth.resetTitle": { en: "Reset your password", es: "Restablece tu contraseña" },
  "auth.resetSubtitle": { en: "Enter your email and we'll send you reset instructions.", es: "Ingresa tu correo y te enviaremos las instrucciones." },
  "auth.sendResetLink": { en: "Send reset link", es: "Enviar enlace" },
  "auth.resetConfirmation": { en: "If an account exists for this email address, we've sent password reset instructions. Please check your inbox and spam folder.", es: "Si existe una cuenta con este correo, hemos enviado las instrucciones. Revisa tu bandeja de entrada y spam." },
  "auth.invalidEmail": { en: "Please enter a valid email address.", es: "Ingresa un correo electrónico válido." },
  "auth.networkError": { en: "Network error. Please check your connection and try again.", es: "Error de red. Verifica tu conexión e inténtalo de nuevo." },
  "auth.serverError": { en: "Something went wrong. Please try again in a moment.", es: "Algo salió mal. Inténtalo de nuevo en un momento." },
  "account.title": { en: "Account", es: "Cuenta" },
  "account.email": { en: "Email address", es: "Correo electrónico" },
  "account.changeEmail": { en: "Change email", es: "Cambiar correo" },
  "account.changePassword": { en: "Change password", es: "Cambiar contraseña" },
  "account.currentEmail": { en: "Current email", es: "Correo actual" },
  "account.newEmail": { en: "New email address", es: "Nuevo correo electrónico" },
  "account.confirmEmail": { en: "Confirm new email address", es: "Confirma el nuevo correo" },
  "account.currentPassword": { en: "Current password", es: "Contraseña actual" },
  "account.newPassword": { en: "New password", es: "Nueva contraseña" },
  "account.confirmPassword": { en: "Confirm new password", es: "Confirma la nueva contraseña" },
  "account.emailsDontMatch": { en: "The email addresses don't match.", es: "Los correos no coinciden." },
  "account.passwordsDontMatch": { en: "The passwords don't match.", es: "Las contraseñas no coinciden." },
  "account.passwordTooShort": { en: "Password must be at least 6 characters.", es: "La contraseña debe tener al menos 6 caracteres." },
  "account.wrongPassword": { en: "Your current password is incorrect.", es: "Tu contraseña actual es incorrecta." },
  "account.emailUpdateSent": { en: "Check your new email address to confirm the change.", es: "Revisa tu nuevo correo para confirmar el cambio." },
  "account.passwordUpdated": { en: "Your password has been updated successfully.", es: "Tu contraseña se actualizó correctamente." },
  "account.save": { en: "Save changes", es: "Guardar cambios" },
  "account.back": { en: "Back", es: "Volver" },
  "account.sessionExpired": { en: "Your session has expired. Please sign in again.", es: "Tu sesión ha expirado. Vuelve a iniciar sesión." },
  "account.setNewPassword": { en: "Set a new password", es: "Establece una nueva contraseña" },
  "account.setNewPasswordSubtitle": { en: "Enter and confirm your new password.", es: "Ingresa y confirma tu nueva contraseña." },
